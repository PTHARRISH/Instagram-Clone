...
from .models import PagePermission, Profile, Role, User, UserPermission
...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = BaseUserAdmin.fieldsets + (
        ("Additional Information", {"fields": ("full_name", "mobile")}),
    )

    # Fieldsets for creating new user
    add_fieldsets = BaseUserAdmin.add_fieldsets + (
        ("Additional Information", {"fields": ("full_name", "mobile", "email")}),
    )
...
class ProfileAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("User", {"fields": ("user",)}),
        ("Profile Information", {"fields": ("bio", "avatar", "gender")}),
    )
